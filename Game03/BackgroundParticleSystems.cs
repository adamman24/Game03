...
namespace Game03
{
    public class BackgroundParticleSystem : ParticleSystem
    {
        ...
        public BackgroundParticleSystem(Game game, int maxExplosions) : base(game, maxExplosions * 25)
        {
        ...
        protected override void InitializeParticle(ref Particle p, Vector2 where)
        {
            ...
            var lifetime = RandomHelper.NextFloat(.5f, 1);
