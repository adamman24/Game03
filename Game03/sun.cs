...
namespace Game03
{
    ...
    public class Cube
    {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            effect.View = Matrix.CreateRotationY(angle*40) * Matrix.CreateLookAt(
                new Vector3(-5, 10, -10),
                new Vector3(13,-50,-5),
                Vector3.Up
            );
        ...
        public void InitializeVertices()
        {
            ...
            new VertexPositionColor() { Position = new Vector3(-1, -1, -1), Color = Color.Yellow },
            new VertexPositionColor() { Position = new Vector3( 1, -1, -1), Color = Color.Red },
            new VertexPositionColor() { Position = new Vector3(-1,  1,  1), Color = Color.Yellow },
            new VertexPositionColor() { Position = new Vector3( 1,  1,  1), Color = Color.Red },
            new VertexPositionColor() { Position = new Vector3(-1, -1,  1), Color = Color.Orange },
